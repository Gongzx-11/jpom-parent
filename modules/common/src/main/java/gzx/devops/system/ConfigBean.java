...
public class ConfigBean {
     ...
     * 用户名header
     */
    public static final String JPOM_SERVER_USER_NAME = "Server-UserName";

    public static final String JPOM_AGENT_AUTHORIZE = "Agent-Authorize";
     ...
     *
     */
    public static final String AUTHORIZE_USER_KEY = "DevOps.authorize.agentName";
    /**
     *
     */
    public static final String AUTHORIZE_PWD_KEY = "DevOps.authorize.agentPwd";
    /**
     * 程序升级信息文件
     */
    public static final String UPGRADE = "upgrade.json";
    /**
     *程序运行的 application 标识
     */
    ...
    public File getPidFile() {
        return new File(getDataPath(), StrUtil.format("pid.{}.{}",
                DevOpsApplication.getAppType().name(), JpomManifest.getInstance().getPid()));
    }
    ...
    public File getApplicationJpomInfo(Type type) {
        return FileUtil.file(SystemUtil.getUserInfo().getTempDir(), "DevOps", type.name());
    }
