...
//todo "execution(public * io.jpom.controller..*.*(..))")
    @Pointcut("execution(public * gzx.devops.controller..*.*(..))")
    public void webLog() {
        //
    }
    ...
    public String getPropertyValue() {
        String path = StringUtil.getArgsValue(DevOpsApplication.getArgs(), "DevOps.log");
