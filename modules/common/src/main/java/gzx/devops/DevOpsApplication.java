...
import gzx.devops.common.JpomApplicationEvent;
import gzx.devops.common.JpomManifest;
import gzx.devops.common.Type;
import gzx.devops.common.interceptor.PluginFeatureInterceptor;
import gzx.devops.plugin.PluginFactory;
...
public class DevOpsApplication extends ApplicationBuilder {
    ...
    public DevOpsApplication(Type appType, Class<?> appClass, String[] args) throws Exception {
        super(appClass);
        //
        checkEvent(args);
        DevOpsApplication.appType = appType;
        DevOpsApplication.appClass = appClass;
        DevOpsApplication.args = args;
