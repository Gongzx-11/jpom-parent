...
public class JvmUtil {
     ...
     * 旧版系统进程标记
     */
    private static final String OLD2_JPOM_PID_TAG = "DevOps.application";
    private static final String POM_PID_TAG = "DDevOps.application";
    /**
     * 记录错误的进程信息，避免重复获取
     */
    ...
    public static String getJpomPidTag(String id, String path) {
        return String.format("-%s=%s -DDevOps.basedir=%s", POM_PID_TAG, id, path);
    }
