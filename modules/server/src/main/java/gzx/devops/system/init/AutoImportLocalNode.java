...
public class AutoImportLocalNode {
    //todo AGENT_MAIN_CLASS = "io.jpom.JpomAgentApplication"
    private static final String AGENT_MAIN_CLASS = "gzx.devops.DevOpsAgentApplication";
    ...
    private static void install() {
        ...
        jsonObject.put("desc", "请勿删除此文件,服务端安装id和客户端互通关联");
