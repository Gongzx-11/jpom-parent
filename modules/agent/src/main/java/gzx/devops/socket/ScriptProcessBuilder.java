...
import gzx.devops.model.data.ScriptModel;
    ...
    public void run() {
        ...
        try {
            process = processBuilder.start();
            {
                ...
                InputStreamReader inputStreamReader = new InputStreamReader(inputStream, DevOpsApplication.getCharset());
            ...
            }
            {
                ...
                InputStreamReader inputStreamReader = new InputStreamReader(errorInputStream, DevOpsApplication.getCharset());
                BufferedReader results = new BufferedReader(inputStreamReader);
