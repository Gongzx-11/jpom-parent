...
//        todo  InputStream inputStream = ResourceUtil.getStream("classpath:/bin/jpomAgent.zip");
        InputStream inputStream = ResourceUtil.getStream("classpath:/bin/GZXTomcatAgent.zip");
        if (inputStream == null) {
            throw new JpomRuntimeException("GZXTomcatAgent.zip不存在");
        }
